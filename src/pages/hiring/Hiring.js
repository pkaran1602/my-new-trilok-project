...
import stylesheet from "./hiring.module.css";
import profile from "../../assets/profile.png";
import { add_hiring_detail } from "../../services/userServices";
...
const Hiring = () => {
  ...
  const validate = (name, value) => {
    switch (name) {
      case "first_name":
        if (value.length < 3) {
          setErrors({ ...errors, first_name: "Name Must be atleast 3 Char" })
        } else {
      ...
      case "last_name":
        if (value.length < 3) {
          setErrors({ ...errors, last_name: "Name Must be atleast 3 Char" })
        } else {
  ...
  const submitFun = (e) => {
    ...
    add_hiring_detail(formdata).then((result) => {
      if (result.success && result.code === 1) {
        ...
        setUser(int_data);
        setShow1(true);
        navigate(`/hiring/upload_hiring_detail/${result.data._id}`)
              ...
              <div>
                ...
                <Row>
                  <Col className="me-1">
                    {" "}
                    <div>
                      <label for="email">First Name <span className="text-danger" style={{ fontSize: '20px' }}>*</span> </label>
                      <input
                        required
                        type="text"
                        name="first_name"
                  ...
                  <Col className="">
                    <div>
                      <label for="last_name">Last Name<span className="text-danger" style={{ fontSize: '20px' }}>*</span> </label>
                      <input
                        required
                        type="text"
                        name="last_name"
                ...
                <Row>
                  <Col>
                    <div>
                      <label for="email">Email<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                      <input
                        required
                        type="email"
                        name="email"
                ...
                <Row>
                  <Col>
                    <div>
                      <label for="phone">Phone No<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                      <input
                        required
                        type="tel"
                        name="phone"
                ...
                <Row className="mt-2 mb-2">
                  <Col>
                    <div className={stylesheet.expected_date}>
                      <label for="birth_date">Date of Birth<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                      <input
                        required
                        type="date"
                        name="birth_date"
                  ...
                  <Col>
                    <div className={stylesheet.expected_date}>
                      <label for="join_date">Expected Join Date<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                      <input
                        required
                        type="date"
                ...
                <Row>
                  <Col>
                    <div className={stylesheet.post_exp}>
                      <div>
                        <label for="applied_for_post">Post for apply<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                        <input
                          required
                          type="text"
                ...
                <Row className="mb-2">
                  <Col className="me-1">
                    <div>
                      <label for="exp">Experience<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                      <select
                        required
                ...
                <Row className="mt-2 mb-2">
                  <label for="current">Current CTC<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                ...
                <Row className="mb-2">
                  <label for="current">Expected CTC<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                  <Col className="ml-2">
                    <div>
                      <input
                        placeholder="Monthly"
                ...
                <Row className="mt-2 mb-2">
                  <label style={{ marginBottom: "10px" }} for="refference">
                    Reference<span className="text-danger" style={{ fontSize: '20px' }}>*</span>
                  </label>
                ...
                <Row>
                  <Col>
                    <div className={stylesheet.education}>
                      <label for="education"> Academic Highest Education<span className="text-danger" style={{ fontSize: '20px' }}>*</span></label>
                      <select
                        required
                        ...
                        onChange={handleChange}
                      >
                        <option value="">Select Your Qulification<span className="text-danger" style={{ fontSize: '20px' }}>*</span></option>
                ...
                <Row>
                  <Col>
                    ...
                    <label for="current_company">
                      Last/Current Comapany Name<span className="text-danger" style={{ fontSize: '20px' }}>*</span>
                    </label>
                    <input
                      required
